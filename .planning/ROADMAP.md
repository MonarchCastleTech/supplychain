...
**Plans**: 4 plans
Plans:
- [ ] 08-01-PLAN.md — Wave 0 register tests + _memo helper/seams + memoize fan-in/concentration/criticality/scenario (PERF-01)
- [ ] 08-02-PLAN.md — No-restart invariant guard over simple filter/style/highlight handlers; bReset allow-listed (PERF-01)
- [ ] 08-03-PLAN.md — Node micro-bench (cold vs warm) + recorded latency improvement under docs/perf/ (PERF-01 SC2)
...
| 8. Interaction Performance | 0/4 | Planned | - |
