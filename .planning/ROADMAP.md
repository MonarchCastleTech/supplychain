...
- [x] 09-02-PLAN.md — Hero overlay focus trap + keyboard-only journey + ARIA assertions (PERF-03)
- [x] 09-03-PLAN.md — Playwright 390x844 + keyboard + focus-trap smoke; full-suite green gate + human-verify (PERF-02/03)
**UI hint**: yes
