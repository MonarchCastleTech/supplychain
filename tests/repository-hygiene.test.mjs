...
const methodologyEvidence = ["FACTUAL_DATA_VERIFICATION.md"];
const quickStartCommands = ["npm ci","python -m http.server 8080"];
const architectureIdentifiers = ["js/","data/","scripts/"];
const thirdPartyExclusions = ["company, market-cap, and supply-chain datasets","logos, trademarks, screenshots, and external assets"];
const licenseDecision = "new-mit";

test("MonarchCastleTech/supplychain exposes the complete repository documentation contract", () => {
...
test("MonarchCastleTech/supplychain keeps every managed image local and ships a valid social preview", () => {
...
test("MonarchCastleTech/supplychain documents citation, rights, and HTTPS policy", () => {
